...
<head>
    ...
    <title>Eleganckie dla Kobiet - WearYourSelf</title>
    <meta name="description" content="Elegancka Odzież Damska - Żakiety, Sukienki, Płaszcze i wiele więcej. Oferujemy wysokiej jakości odzież Elegancką Damską Męską i Dziecięcą. Szeroki wybór znakomitej jakości produktów w niskich cenach!"/>
...
<body>
    ...
    <div class="container">
		...
		<section>
		<h2 class="display-3">DAMSKIE</h2>
			<div class="products mt-5 mb-5">
				<div class="row">
					<?php
						require_once "womenproducts.php";
					?>
				</div>
			</div>	
		</section>
