...
<head>
    ...
    <title>Elegancka Odzież - WearYourSelf</title>
...
<body>
    ...
    <div class="container">
		...
		<section>
		<h2 class="display-3">BEST SELLERS</h2>
		<div class="midbar">
			<div class="row">
				<?php
					require_once "bestsellers.php"
				?>
			<!--
					<div class="col-5 col-sm-3 offset-1 offset-sm-0" ><img src="img/sale1.jpg" alt=""><p>230 zł</p></div>
					<div class="col-5 col-sm-3  offset-sm-0"><img src="img/sale2.jpg" alt=""><p>400 zł</p></div>
					<div class="col-5 col-sm-3 offset-1 offset-sm-0"><img src="img/sale3.jpg" alt=""><p>600 zł</p></div>
					<div class="col-5 col-sm-3  offset-sm-0"><img src="img/sale4.jpg" alt=""><p>600 zł</p></div>
			-->
			</div>
		</div>
		</section>
		...
		<div class="midbar">
			<div class="row">
				...
				?>
				<!--
					<div class="col-5 col-sm-3 offset-1 offset-sm-0" ><img src="img/sale1.jpg" alt=""><p>-40%</p></div>
					<div class="col-5 col-sm-3  offset-sm-0"><img src="img/sale2.jpg" alt=""><p>-30%</p></div>
					<div class="col-5 col-sm-3 offset-1 offset-sm-0"><img src="img/sale3.jpg" alt=""><p>-60%</p></div>
					<div class="col-5 col-sm-3  offset-sm-0"><img src="img/sale4.jpg" alt=""><p>-39%</p></div>
				-->
			</div>
		</div>
		</section>
