			...
			$_SESSION['koszyknum']++;
				...
				try
				{
					...
					else
					{
						...
						$result=$connect->query("SELECT * FROM products WHERE active=1 AND type='female'");
